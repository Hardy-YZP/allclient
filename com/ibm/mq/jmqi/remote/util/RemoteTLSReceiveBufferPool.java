...
/*     */ 
/*     */ 
/*     */ public class RemoteTLSReceiveBufferPool
/*     */   extends JmqiObject
/*     */   implements RemoteCommsBufferPoolInterface
/*     */ {
/*     */   static {
/*  42 */     if (Trace.isOn) {
/*  43 */       Trace.data("RemoteTLSReceiveBufferPool", "static", "SCCS id", "@(#) MQMBID sn=p932-L230207 su=_mMBuZqcAEe2pWoFAaNK_Tg pn=com.ibm.mq.jmqi.remote/src/com/ibm/mq/jmqi/remote/util/RemoteTLSReceiveBufferPool.java");
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public RemoteTLSReceiveBufferPool(JmqiEnvironment env) {
/*  55 */     super(env);
/*     */ 
/*     */ 
/*     */ 
...
/*     */     if (Trace.isOn)
/*     */       Trace.entry(this, "RemoteTLSReceiveBufferPool", "<init>(JmqiEnvironment)", new Object[] { env }); 
/*     */     if (Trace.isOn)
/*     */       Trace.exit(this, "RemoteTLSReceiveBufferPool", "<init>(JmqiEnvironment)"); 
/*     */   }
/*     */   public String toString() {
/* 182 */     if (this.toStringInProgress)
/* 183 */       return String.format("RemoteTLSReceiveBufferPool @0x%x", new Object[] {
/* 184 */             Integer.valueOf(System.identityHashCode(this))
/*     */           }); 
/* 186 */     this.toStringInProgress = true;
/* 187 */     String result = String.format("RemoteTLSReceiveBufferPool @0x%x contains %s", new Object[] {
/*     */           
...
/*     */     if (Trace.isOn)
/*     */       Trace.entry(this, "RemoteTLSReceiveBufferPool", "allocBuffer(int)", new Object[] { Integer.valueOf(capacity) }); 
/*     */     RemoteCommsBuffer buffer = null;
...
/*     */     if (Trace.isOn)
/*     */       Trace.exit(this, "RemoteTLSReceiveBufferPool", "allocBuffer(int)", buffer); 
/*     */     return buffer;
/*     */   }
/*     */   
/*     */   public void freeBuffer(RemoteCommsBuffer iBuffer) throws JmqiException {
/*     */     if (Trace.isOn)
/*     */       Trace.entry(this, "RemoteTLSReceiveBufferPool", "freeBuffer(RemoteCommsBuffer)", new Object[] { iBuffer }); 
...
/*     */       if (Trace.isOn)
/*     */         Trace.throwing(this, "RemoteTLSReceiveBufferPool", "freeBuffer(RemoteCommsBuffer)", (Throwable)traceRet1, 1); 
/*     */       throw traceRet1;
/*     */     } 
...
/*     */         if (Trace.isOn)
/*     */           Trace.throwing(this, "RemoteTLSReceiveBufferPool", "freeBuffer(RemoteCommsBuffer)", (Throwable)traceRet2, 2); 
/*     */         throw traceRet2;
/*     */       } 
...
/*     */     if (Trace.isOn)
/*     */       Trace.exit(this, "RemoteTLSReceiveBufferPool", "freeBuffer(RemoteCommsBuffer)"); 
/*     */   }
/*     */ }


/* Location:              D:\download\com.ibm.mq.allclient-9.3.2.0.jar!\com\ibm\mq\jmqi\remot\\util\RemoteTLSReceiveBufferPool.class
