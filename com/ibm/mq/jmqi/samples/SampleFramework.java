...
public class SampleFramework {
  static {  // AUTOINSERTEDTRACE
    if (Trace.isOn) {
      Trace.data( "com.ibm.mq.jmqi.samples.SampleFramework", "static", "SCCS id",
        "@(#) MQMBID sn=p932-L230207 su=_mMBuZqcAEe2pWoFAaNK_Tg pn=com.ibm.mq.jmqi/src/com/ibm/mq/jmqi/samples/SampleFramework.java");
    }
  }
     // AUTOINSERTEDTRACE
  ...
  public static final String sccsid = "@(#) MQMBID sn=p932-L230207 su=_mMBuZqcAEe2pWoFAaNK_Tg pn=com.ibm.mq.jmqi/src/com/ibm/mq/jmqi/samples/SampleFramework.java";
